export default function AmenityIcon({ amenity }) {
  ...
  if (name.includes("view") || name.includes("courtyard")) {
    return (
      <svg
  ...
  if (name.includes("body soap") || name.includes("soap")) {
    return (
      <svg
        className="w-5 h-5 text-gray-900"
        fill="none"
  ...
  if (name.includes("coffee maker") || name.includes("coffee")) {
    return (
      <svg
        className="w-5 h-5 text-gray-900"
        fill="none"
